                ...
                <tbody>
                    {books.map((book,index)=>(
                        <tr key={book._id} className='h-8'>
                            ...
                            <td className='border border-slate-600 rounded-md text-center max-md:hidden'>{book.description}</td>
                            <td className='border border-slate-600 rounded-md text-center max-md:hidden'>{book.publishedYear}</td>
